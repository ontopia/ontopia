...
/**
 * INTERNAL: An indented StringBuilder implementation.  
 */
public class IndentedStringBuilder
{
  ...
  /**
   * Create a new indented StringBuilder instance with a 
   * default indentation of {@link DEFAULT_INDENTATION_SIZE}.
   */
  ...
  /**
   * Create a new indented StringBuilder instance.
   *  
