...
public class LocalParseContext 
{
  ...
  public PathExpressionIF createPathExpression() throws AntlrWrapException {
    ...
    if (path == null)
      throw new AntlrWrapException(
          new InvalidQueryException("unable to create path expression"));
    return path;
  }
  ...
  public PathElementIF createElement(String name) throws AntlrWrapException {
    ...
    if (element == null)
      throw new AntlrWrapException(
          new InvalidQueryException("unable to create path element '" + name + "'"));
    return element;
  }
  
  public PathRootIF createTopic(String type, String id) throws AntlrWrapException {
    PathRootIF root = pathExpressionFactory.createTopic(type, id);
    if (root == null)
      throw new AntlrWrapException(
          new InvalidQueryException("unable to create topic literal with id '" + id + "'"));
    return root;
  }
  ...
  public PathRootIF createVariable(String name) throws AntlrWrapException {
    ...
    if (root == null)
      throw new AntlrWrapException(
          new InvalidQueryException("unable to create variable '" + name + "'"));
    return root;
  }
  ...
  public PathRootIF createEmptyRoot() throws AntlrWrapException {
    ...
    if (root == null)
      throw new AntlrWrapException(
          new InvalidQueryException("unable to create empty root"));
    return root;
  }
  ...
  public PathRootIF createAnyRoot() throws AntlrWrapException {
    ...
    if (root == null)
      throw new AntlrWrapException(
          new InvalidQueryException("unable to create wildcard root"));
    return root;
  }
  
  public ExpressionIF createExpression(String type, 
      ExpressionIF... childs) throws AntlrWrapException {
    ExpressionIF expr = expressionFactory.createExpression(type, childs);
    if (expr == null)
      throw new AntlrWrapException(
          new InvalidQueryException("unable to create expression '" + type + "'"));
    return expr;
  }
  ...
  public ExpressionIF createLiteral(String value) throws AntlrWrapException {
    ...
    if (expr == null)
      throw new AntlrWrapException(
          new InvalidQueryException("unable to create literal with value '" + value + "'"));
    return expr;
  }
  ...
  public FunctionIF createFunction(String name) 
    ...
    if (function == null)
      throw new AntlrWrapException(
          new InvalidQueryException("unable to create function '" + name + "'"));
    return function;
  }
}
