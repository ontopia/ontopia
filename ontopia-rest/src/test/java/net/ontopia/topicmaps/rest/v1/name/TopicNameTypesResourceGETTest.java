...
public class TopicNameTypesResourceGETTest extends AbstractV1ResourceTest {
	...
	public void testTopicNameTypes() throws IOException {
		...
		Assert.assertFalse(types.isEmpty()); // only default name
		assertContainsTopics(types, "3");
	}
}
