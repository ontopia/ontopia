...
<template:insert template='/views/template_no_frames.jsp'>
  ...
  <template:put name='content' body='true'>
    ...
    <ul>
      <li>Go to the <a href="manage.jsp">Manage
      ...
      limit, which defaults to 64 MB. You can increase this limit to
      give the Omnigator more memory. Try setting the <tt>JAVA_OPTS</tt>
      environment variable to <tt>-Xmx120M</tt>, for example, and restart
      Tomcat. (Make sure that Tomcat sees the new value.)
    </ul>
