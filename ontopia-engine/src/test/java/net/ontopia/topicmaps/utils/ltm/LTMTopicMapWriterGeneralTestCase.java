...
public class LTMTopicMapWriterGeneralTestCase {
  ...
  /**
   * Exports a file from the directory 'in' to an ltm file in 'ltm'. Canonicalizes the ltm file into the directory
   * 'out'. Compares the file in 'out' with a baseline file in 'baseline'. If recanonicalizeSource is set to true, then
   * the source file is also canonicalized directly into 'baseline' and used as baseline.
   */
  @Test
