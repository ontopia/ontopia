...
/**
 * Exports a file from the directory 'x-in' to an ltm file in 'x-ltm'. Canonicalizes the ltm file into the directory
 * 'x-out'. Compares the file in 'x-out' with a baseline file in 'x-baseline'. The baseline must be created manually,
 * or by inspecting the file in 'out'.
 */
