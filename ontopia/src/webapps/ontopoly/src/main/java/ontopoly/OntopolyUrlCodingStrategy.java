 ...
 */
public class OntopolyUrlCodingStrategy extends BookmarkablePageRequestTargetUrlCodingStrategy
{
   ...
   */
  public OntopolyUrlCodingStrategy(String mountPath, Class bookmarkablePageClass,
  ...
  private String getParameterStringValue(Object param) {
    ...
    if (urlPath.length() > 0)
    {
      ...
      if (pathParts.length > parameterNames.length)
      {
        throw new IllegalArgumentException(
          "Too many path parts, please provide sufficient number of path parameter names: " + pathParts.length + ":" + parameterNames.length);
      }
