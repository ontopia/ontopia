...
import net.ontopia.topicmaps.nav2.webapps.ontopoly.model.CreateAction;
import net.ontopia.topicmaps.nav2.webapps.ontopoly.model.EditMode;
...
import net.ontopia.topicmaps.nav2.webapps.ontopoly.model.InterfaceControl;
