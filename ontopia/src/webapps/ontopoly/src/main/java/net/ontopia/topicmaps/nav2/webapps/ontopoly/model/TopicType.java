...
import net.ontopia.topicmaps.nav2.webapps.ontopoly.utils.FieldAssignmentComparator;
...
//  }
  ...
  public List<FieldAssignment> getFieldAssignments(FieldsView view) {
    ...
    Collections.sort(fieldAssignments, FieldAssignmentComparator.INSTANCE);
