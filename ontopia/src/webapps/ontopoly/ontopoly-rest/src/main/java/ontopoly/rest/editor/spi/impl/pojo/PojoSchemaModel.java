...
public class PojoSchemaModel {
    ...
    public static PojoSchemaProvider parse(String databaseId, String schemaFile) {
        ...
        try {
            ...
            throw new RuntimeException("Problems occurrence when loading '" + schemaFile + "'");
        } finally {
            try {
                istream.close();
            } catch (IOException e) {
...
//        String id = json.get("id").getTextValue();
        ...
        while (fieldNames.hasNext()) {
            ...
            System.out.println("F: " + fieldName + " " + fieldConfig);
        }
        ...
        while (typeNames.hasNext()) {
            ...
            System.out.println("T: " + typeName + " " + typeConfig);
        }
            ...
            if (typeConfig.has("views")) {
                ...
                for (JsonNode viewNode_ : viewsNode) {
                    ...
                    for (JsonNode fieldIdNode : fieldsArray) {
                        ...
                        System.out.println("FN: " + fieldId + " " + fieldConfig);
                        ...
                        System.out.println("F: " + viewId + " " + field.getId() + " " + field.getName() + " " + field.getAvailableFieldValueTypes());
                    }
                }
            }
            System.out.println("T: " + type.getId() + " " + type.getName() + " " + type.getViews(null));
            System.out.println("TF: " + type.getFields());
