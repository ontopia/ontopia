// $Id: Block.java,v 1.10 2004/11/12 11:47:19 grove Exp $

package net.ontopia.topicmaps.nav.utils.structures;

/** 
 * INTERNAL: Holds the selection and presentation info for blocks. An instance is used 
...
public class Block {
  ...
  /**
   * Constructor used by <code>BlockTag</code>.
   */
  public Block (String renderName, 
