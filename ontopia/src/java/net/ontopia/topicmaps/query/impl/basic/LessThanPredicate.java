...
// $Id: LessThanPredicate.java,v 1.9 2007/09/18 10:03:56 lars.garshol Exp $
 ...
 */
public class LessThanPredicate implements BasicPredicateIF {
  ...
  public QueryMatches satisfy(QueryMatches matches, Object[] arguments)
    ...
    for (int ix = 0; ix <= matches.last; ix++) {
      ...
      if (PredicateUtils.compare(value1, value2) >= 0)
        continue; // if not comparable and less than - skip it
